    ...
    <div className="pt-16">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">정산 내역</h1>
          <p className="text-slate-500 dark:text-slate-400">
            멘토님의 정산 내역을 확인하실 수 있습니다.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* 정산 목록 */}
            <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
              <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-6">정산 내역</h2>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <h3 className="text-lg font-bold text-slate-900 dark:text-white">
                                {formatYearMonth(settlement.settlementPeriod)}
                              </h3>
                            ...
                            <div className="space-y-1 text-sm text-slate-600 dark:text-slate-400">
                              ...
                              {settlement.refundAmount && settlement.refundAmount > 0 && (
                                <div className="flex items-center justify-between">
                                  <span>환불 차감:</span>
              ...
              {isDetailLoading ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedSettlement.settlement.refundAmount && selectedSettlement.settlement.refundAmount > 0 && (
                      <div className="flex justify-between text-sm">
